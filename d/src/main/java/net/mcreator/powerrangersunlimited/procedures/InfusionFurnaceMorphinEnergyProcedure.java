...
public class InfusionFurnaceMorphinEnergyProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 3)).getItem() == PowerRangersUnlimitedModItems.MORPHIN_ENERGY_BUCKET.get()) {
			{
